...
## Contributions
- **Derek**: README, database clients, backend queries, and Dash application for all the minimal requirements. 
- **Meera**: Extra credit capability, as well as the associated application updates, and video demo.
